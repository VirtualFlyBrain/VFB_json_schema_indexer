...
class SplitClassTermInfoQueryIndexer(BaseQueryIndexer):
    ...
    def get_parameters_query(self) -> str:
        ...
        """
        return "MATCH (n:Split:Class) RETURN collect(distinct n.short_form) as ids"
    ...
    def get_vfb_json_query(self, ids: List[str]) -> str:
        ...
        :return: query string
        """
        return self.ql.split_class_term_info(short_form=ids)
