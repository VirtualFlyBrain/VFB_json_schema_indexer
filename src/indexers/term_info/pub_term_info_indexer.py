...
class PubTermInfoQueryIndexer(BaseQueryIndexer):
    ...
    def get_parameters_query(self) -> str:
        ...
        """
        return "MATCH (i:pub:Individual) RETURN collect(distinct i.short_form) as ids"
    ...
    def get_vfb_json_query(self, ids: List[str]) -> str:
        ...
        :return: query string
        """
        return self.ql.pub_term_info(short_form=ids)
