...
class TemplateTermInfoQueryIndexer(BaseQueryIndexer):
    ...
    def get_parameters_query(self) -> str:
        ...
        """
        return "MATCH (i:Template) RETURN collect(distinct i.short_form) as ids"
    ...
    def get_vfb_json_query(self, ids: List[str]) -> str:
        ...
        :return: query string
        """
        return self.ql.template_term_info(short_form=ids)
