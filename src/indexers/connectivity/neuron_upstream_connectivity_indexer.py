...
class NeuronUpstreamConnectivityIndexer(BaseQueryIndexer):
    """
    Indexes upstream connectivity for each neuron class.
    For a given primary neuron class, collects all upstream partner classes
    (what connects TO the primary class) along with connection statistics.
    ...
    def get_vfb_json_query(self, ids: List[str]) -> str:
        ...
        return (
            ...
            "MATCH (primary)<-[:SUBCLASSOF*0..]-(c2:Class:Neuron)\n"
